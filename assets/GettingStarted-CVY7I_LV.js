import{c,a,o as r}from"./index-BM99p-BW.js";const n=(e,t)=>{const o=e.__vccOpts||e;for(const[d,s]of t)o[d]=s;return o},l={},i={class:"docs-article"};function p(e,t){return r(),c("article",i,[...t[0]||(t[0]=[a(`<span class="docs-tag">@toife/vue</span><h1>Tài liệu component Vue</h1><p class="docs-lead"> Trang này demo toàn bộ tag <code>t-*</code> của <code>@toife/components/vue</code>. Types, defaults và SCSS nằm ở <code>@toife/components/core</code>. Vue chỉ adapt core. </p><h2 class="docs-kicker">Cài đặt</h2><pre class="setup-code">pnpm add @toife/vue vue vue-router @toife/gesture @toife/sass-layer sass</pre><h2 class="docs-kicker">Đăng ký</h2><pre class="setup-code">import { createApp } from &quot;vue&quot;;
